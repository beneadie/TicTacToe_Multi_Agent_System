...
public class Player extends ASTRAClass {
	public Player() {
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Player", new int[] {54,25,56,11},
				new Statement[] {
					new Subgoal(
						"Player", new int[] {55,10,56,11},
						new Goal(
		...
		addRule(new Rule(
			...
			new Block(
				"Player", new int[] {71,45,82,11},
				new Statement[] {
					new BeliefUpdate('+',
						"Player", new int[] {72,10,82,11},
					...
					new If(
						...
						new Block(
							"Player", new int[] {78,38,81,11},
							new Statement[] {
								new Send("Player", new int[] {79,15,79,39},
									new Performative("inform"),
									new Variable(Type.STRING, "opp"),
									new Predicate("end", new Term[] {})
								),
								new BeliefUpdate('+',
									"Player", new int[] {80,15,81,11},
									new Predicate("end", new Term[] {})
								)
							}
						)
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Player", new int[] {84,36,88,6},
				new Statement[] {
					new BeliefUpdate('-',
						"Player", new int[] {85,10,88,6},
						new Predicate("spot", new Term[] {
							new Variable(Type.INTEGER, "Sq"),
							Primitive.newPrimitive("free")
						})
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Player", new int[] {90,67,99,6},
				new Statement[] {
					new ModuleCall("C",
						"Player", new int[] {91,10,91,59},
						new Predicate("println", new Term[] {
							Operator.newOperator('+',
					...
					new Query(
						"Player", new int[] {94,10,94,34},
						new Predicate("token", new Term[] {
							new Variable(Type.STRING, "tok",false)
						})
					),
					new If(
						"Player", new int[] {95,10,99,6},
						new Comparison("==",
							new QueryTerm(
								new Predicate("winner", new Term[] {
									new Variable(Type.STRING, "T")
						...
						new Block(
							"Player", new int[] {95,39,97,11},
							new Statement[] {
								new BeliefUpdate('+',
									"Player", new int[] {96,15,97,11},
									new Predicate("turn", new Term[] {
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Player", new int[] {101,48,103,6},
				new Statement[] {
					new BeliefUpdate('+',
						"Player", new int[] {102,10,103,6},
						new Predicate("end", new Term[] {})
					)
				}
			)
		...
		addRule(new Rule(
			"Player", new int[] {105,10,105,17},
			new BeliefEvent('+',
				new Predicate("end", new Term[] {})
			),
			Predicate.TRUE,
			new Block(
				"Player", new int[] {105,16,110,6},
				new Statement[] {
					new ForEach(
						"Player", new int[] {106,10,110,6},
						new Predicate("spot", new Term[] {
							new Variable(Type.INTEGER, "Sq",false),
							Primitive.newPrimitive("free")
						}),
						new Block(
							"Player", new int[] {106,40,109,11},
							new Statement[] {
								new BeliefUpdate('-',
									"Player", new int[] {107,15,109,11},
									new Predicate("spot", new Term[] {
										new Variable(Type.INTEGER, "Sq"),
										Primitive.newPrimitive("free")
									})
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Player", new int[] {113,23,116,6},
				new Statement[] {
					new ModuleCall("C",
						"Player", new int[] {114,10,114,36},
						new Predicate("println", new Term[] {
							Operator.newOperator('+',
								new Variable(Type.INTEGER, "Sq"),
		...
		addRule(new Rule(
			...
			Predicate.TRUE,
			new Block(
				"Player", new int[] {120,49,148,11},
				new Statement[] {
					new ModuleCall("C",
						"Player", new int[] {121,10,121,51},
						new Predicate("println", new Term[] {
					...
					new BeliefUpdate('+',
						"Player", new int[] {122,10,148,11},
						new Predicate("opponent", new Term[] {
							new Variable(Type.STRING, "opponent")
						})
					),
					new BeliefUpdate('+',
						"Player", new int[] {123,10,148,11},
						new Predicate("token", new Term[] {
							new Variable(Type.STRING, "token")
						})
					),
					new Wait(
						"Player", new int[] {125,10,148,11},
						new Predicate("free", new Term[] {
							Primitive.newPrimitive(1)
						})
					),
					new If(
						"Player", new int[] {127,10,148,11},
						new Comparison("==",
							new Variable(Type.STRING, "token"),
							Primitive.newPrimitive("O")
						),
						new Block(
							"Player", new int[] {127,27,129,16},
							new Statement[] {
								new BeliefUpdate('+',
									"Player", new int[] {128,15,129,16},
									new Predicate("turn", new Term[] {
										new Variable(Type.STRING, "token")
									})
								)
						...
						new Block(
							"Player", new int[] {130,15,148,11},
							new Statement[] {
							}
						)
					),
					new Wait(
						"Player", new int[] {132,10,148,11},
						new NOT(
							new Predicate("free", new Term[] {
								new Variable(Type.INTEGER, "Sq",false)
							})
					...
					new If(
						"Player", new int[] {135,10,148,11},
						new Predicate("drawn", new Term[] {
							new Variable(Type.STRING, "X",false)
						}),
						new Block(
							"Player", new int[] {135,30,137,11},
							new Statement[] {
								new ModuleCall("C",
									"Player", new int[] {136,15,136,35},
									new Predicate("println", new Term[] {
						...
						new If(
							"Player", new int[] {138,15,148,11},
							new Predicate("winner", new Term[] {
								new Variable(Type.STRING, "Y",false)
							}),
							new Block(
								"Player", new int[] {138,36,147,11},
								new Statement[] {
									new ModuleCall("C",
										"Player", new int[] {139,15,139,42},
										new Predicate("println", new Term[] {
											Operator.newOperator('+',
									...
									new If(
										"Player", new int[] {140,15,147,11},
										new Comparison("==",
											new Variable(Type.STRING, "Y"),
											Primitive.newPrimitive("O")
										),
										new Block(
											"Player", new int[] {140,28,142,16},
											new Statement[] {
												new ModuleCall("C",
													"Player", new int[] {141,15,141,38},
													new Predicate("println", new Term[] {
										...
										new If(
											"Player", new int[] {143,20,147,11},
											new Comparison("==",
												new Variable(Type.STRING, "Y"),
												Primitive.newPrimitive("X")
											),
											new Block(
												"Player", new int[] {143,33,146,16},
												new Statement[] {
													new ModuleCall("C",
														"Player", new int[] {144,20,144,43},
														new Predicate("println", new Term[] {
